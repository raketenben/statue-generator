<script>
	import DatpackExporter from "$lib/DatpackExporter.svelte";
...
<header class="bg-surface-700 p-4">
	...
	<h2 class="h3 text-primary-500">Create posable player-statues for Minecraft</h2>
</header>
<main class="columns-xl gap-5 p-5">
	<SkinSelector />
	<DatpackExporter />
	<StatueCommands />
	<TutorialPanel />
